...
public class DashboardService {
    ...
    public Map<String, Object> getDashboardData(User user) {
        ...
        // Fetch data once to reduce DB queries and latency
        ...
        List<WeeklyPlan> weeklyPlans = weeklyPlanRepository.findByUser(user).stream().toList();
        LocalDate endDate = LocalDate.now();
        LocalDate startDate = endDate.minusDays(6);
        List<UserProgress> recentProgress = userProgressRepository.findByUserAndDateBetween(user, startDate, endDate);
        ...
        dashboardData.put("careerProgress", calculateCareerProgress(allProgress, quizResults, weeklyPlans));
        
        // Skills data from quiz results
        dashboardData.put("skillsData", getSkillsData(quizResults));
        
        // Learning progress from weekly plans
        dashboardData.put("learningProgressData", getLearningProgressData(weeklyPlans));
        
        // Activity data (last 7 days)
        dashboardData.put("activityData", getActivityData(recentProgress));
        
        // Stats
        dashboardData.put("stats", getUserStats(allProgress, quizResults, weeklyPlans));
    ...
    private Map<String, Object> calculateCareerProgress(List<UserProgress> allProgress, List<QuizResult> quizResults, List<WeeklyPlan> weeklyPlans) {
    ...
    private List<Map<String, Object>> getSkillsData(List<QuizResult> latestQuizResult) {
    ...
    private List<Map<String, Object>> getLearningProgressData(List<WeeklyPlan> weeklyPlans) {
    ...
    private List<Map<String, Object>> getActivityData(List<UserProgress> progressList) {
        LocalDate endDate = LocalDate.now();
        LocalDate startDate = endDate.minusDays(6);
    ...
    private Map<String, Object> getUserStats(List<UserProgress> allProgress, List<QuizResult> quizResults, List<WeeklyPlan> weeklyPlans) {
        ...
        // Current streak
        int currentStreak = calculateCurrentStreak(allProgress);
    ...
    private int calculateCurrentStreak(List<UserProgress> progressList) {
